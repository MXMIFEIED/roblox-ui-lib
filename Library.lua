...
local drawing  = loadstring(syn.request({Url = 'https://raw.githubusercontent.com/MXMIFEIED/roblox-ui-lib/main/1', Method = 'GET'}).Body)()
local tween = loadstring(syn.request({Url = 'https://raw.githubusercontent.com/MXMIFEIED/roblox-ui-lib/main/2', Method = 'GET'}).Body)()
